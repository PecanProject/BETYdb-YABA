...
class BasicTests(unittest.TestCase):
    ...
    def test_insert_experiments(self):
        ...
        response = requests.post(
            'http://localhost:5000/yaba/v1/experiments?username=guestuser', files=files)
    ...
    def test_insert_sites(self):
        ...
        response = requests.post('http://localhost:5000/yaba/v1/sites',
                            files=files)
        self.assertEqual(response.status_code, 201)
    ...
    def test_insert_treatments(self):
        ...
        response = requests.post(
            'http://localhost:5000/yaba/v1/treatments?username=guestuser', files=files)
        self.assertEqual(response.status_code, 201)
        self.assertTrue(response.ok)
    ...
    def test_insert_cultivars(self):
        ...
        files = {'fileName': open(csv, 'rb')}
        response = requests.post(
            'http://localhost:5000/yaba/v1/cultivars', files=files)
        self.assertEqual(response.status_code, 201)
        self.assertTrue(response.ok)
    ...
    def test_insert_citations(self):
        ...
        files = {'fileName': open(csv, 'rb')}
        response = requests.post(
            'http://localhost:5000/yaba/v1/citations?username=guestuser', files=files)
        self.assertEqual(response.status_code, 201)
        self.assertTrue(response.ok)
    ...
    def test_insert_experimentSites(self):
        ...
        files = {'fileName': open(csv, 'rb')}
        response = requests.post(
            'http://localhost:5000/yaba/v1/experiments_sites', files=files)
        self.assertEqual(response.status_code, 201)
        self.assertTrue(response.ok)
    ...
    def test_insert_experimentTreatments(self):
        ...
        files = {'fileName': open(csv, 'rb')}
        response = requests.post(
            'http://localhost:5000/yaba/v1/experiments_treatments', files=files)
        self.assertEqual(response.status_code, 201)
        self.assertTrue(response.ok)
    ...
    def test_insert_sitesCultivars(self):
        ...
        files = {'fileName': open(csv, 'rb')}
        response = requests.post(
            'http://localhost:5000/yaba/v1/sites_cultivars', files=files)
        self.assertEqual(response.status_code, 201)
        self.assertTrue(response.ok)
    ...
    def test_insert_citationsSites(self):
        ...
        files = {'fileName': open(csv, 'rb')}
        response = requests.post(
            'http://localhost:5000/yaba/v1/citations_sites', files=files)
        self.assertEqual(response.status_code, 201)
        self.assertTrue(response.ok)
