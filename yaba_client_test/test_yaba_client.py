...
class BasicTests(unittest.TestCase):
    ...
    def test_insert_sites(self):
        ...
        response = requests.post("http://0.0.0.0:6001/sites", files=files)
        self.assertEqual(response.status_code, 200)
        self.assertTrue(response.ok)
    ...
    def test_insert_cultivars(self):
        ...
        csv = "input_files/" + csv_filename
        files = {"fileName": open(csv, "rb")}
        response = requests.post("http://0.0.0.0:6001/cultivars", files=files)
        self.assertEqual(response.status_code, 200)
        self.assertTrue(response.ok)
    ...
    def test_insert_experimentSites(self):
        ...
        csv = "input_files/" + csv_filename
        files = {"fileName": open(csv, "rb")}
        response = requests.post("http://0.0.0.0:6001/experiments_sites", files=files)
        self.assertEqual(response.status_code, 200)
        self.assertTrue(response.ok)
    ...
    def test_insert_sitesCultivars(self):
        ...
        csv = "input_files/" + csv_filename
        files = {"fileName": open(csv, "rb")}
        response = requests.post("http://0.0.0.0:6001/sites_cultivars", files=files)
        self.assertEqual(response.status_code, 200)
        self.assertTrue(response.ok)
    ...
    def test_insert_citationsSites(self):
        ...
        csv = "input_files/" + csv_filename
        files = {"fileName": open(csv, "rb")}
        response = requests.post("http://0.0.0.0:6001/citations_sites", files=files)
        self.assertEqual(response.status_code, 200)
        self.assertTrue(response.ok)
